...
SNOWSTORM_BASE = os.getenv("SNOWSTORM_BASE", "https://snowstorm.ihtsdotools.org/snowstorm")
...
def fetch_concept(concept_id: str) -> dict:
    ...
    return get_json(api(f"snomed-ct/{SNOMED_BRANCH}/concepts/{concept_id}"))
...
def resolve_release() -> str:
    ...
    try:
        ...
        versions = get_json(api("codesystems/SNOMEDCT/latest"))
